...
vars <- c("IN002","IN031","IN101","IN049","IN019","IN023","IN024",
          ...
          "Natureza jurídica","Tipo de serviço","Nome_Mesorregião","Abrangência","Nome_Município",
...
dado_filter$`Tipo de serviço`


## Preencher com zero as variaveis de esgoto para prestadores de água
...
municipios_filter <- dataset_final[dataset_final$Nome_Município %in% municipios_duplicados$Nome_Município,]

#criando id
municipios_duplicados$id <- paste(municipios_duplicados$Nome_Município,"+",municipios_duplicados$Prestador2)
municipios_filter$id <- paste(municipios_filter$Nome_Município,"+",municipios_filter$Prestador2)
...
#Adicionando dados tratados
dataset_final_2 <- dataset_final[!dataset_final$Nome_Município %in% municipios_duplicados$Nome_Município,]#retirando da original
